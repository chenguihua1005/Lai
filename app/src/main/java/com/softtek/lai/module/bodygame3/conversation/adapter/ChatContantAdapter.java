...
public class ChatContantAdapter extends BaseAdapter {
     ...
     * 构造函数
     */
    public ChatContantAdapter(Context context, List<ChatContactModel> list) {
        this.mInflater = LayoutInflater.from(context);
        this.context = context;
        this.list = list;
    }

    public void updateData(List<ChatContactModel> list) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final ChatContactModel contactListInfo = list.get(position);
