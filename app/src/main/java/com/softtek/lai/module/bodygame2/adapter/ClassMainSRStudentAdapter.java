 ...
 */
public class ClassMainSRStudentAdapter extends BaseAdapter {
     ...
     * 构造函数
     */
    public ClassMainSRStudentAdapter(Context context, List<ClmListModel> list, String t) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        String isHasAssi=model.getIsHasAssi();
