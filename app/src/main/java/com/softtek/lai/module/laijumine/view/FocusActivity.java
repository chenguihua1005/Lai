...
import static com.softtek.lai.R.id.list_fans;
import static com.softtek.lai.R.id.never;
import static com.softtek.lai.R.id.swipe_layout;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==Focus&&resultCode==RESULT_OK)
        {
            ...
            {}
                ...
                {
                    focusInfoModels.get(positions).setFocus(true);
                }
                else {
                    focusInfoModels.get(positions).setFocus(false);
