...
public class WaistlineFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener,HealthRecordManager.HealthRecordCallBack{
...
//        pysicalManager=new PysicalManager(getContext());
    ...
    @Subscribe
    public void getFatList(HealthWaistlineModel healthWaistlineModel) {
        System.out.println("健康记录体重" + healthWaistlineModel.getFirstrecordtime());
