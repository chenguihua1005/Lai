 ...
 */
public class SearchPCAdapter extends BaseAdapter{

    private List<MemberResultModel> pc;
    private Context context;

    public SearchPCAdapter(Context context, List<MemberResultModel> pc) {
        this.pc = pc;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if(convertView==null){
            convertView= LayoutInflater.from(context).inflate(R.layout.search_pc_item,parent,false);
