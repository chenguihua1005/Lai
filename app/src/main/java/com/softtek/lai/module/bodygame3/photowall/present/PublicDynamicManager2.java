 ...
 *
 */
public class PublicDynamicManager2 implements Runnable,UploadImageService2.UploadImageCallback{
    ...
    public PublicDynamicManager2(List<UploadImage> images, Context context) {
        this.images = images;
    ...
    private int size=0;
    public void sendDynamic(PublicDyModel model){
        this.model=model;
        ...
        for(int i=0;i<size;i++){
            queue.offer(new UploadImageService2(this,images.get(i).getImage()));
        }
