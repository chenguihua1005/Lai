...
public class AuditActivity extends BaseActivity implements View.OnClickListener {
    ...
    private RetestAuditModel retestAuditModel;
    ...
    protected void initDatas() {
        ...
        retestAuditModel = new RetestAuditModel("3", "55", "36", "63", "36", "36", "36", "36", "36", "36", "36", "36");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_right:
//                retestAuditModel.setDoLegGirth(tv_retestAudit_doLegGirth+"");
                retestPre.doPostAudit("36", "3", "2016-03-28", retestAuditModel);
                break;
            //信息点击事件
