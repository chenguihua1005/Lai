...
public class GroupAdapter extends BaseAdapter {
    ...
    public GroupAdapter(Context context,  List<EMGroup> groups) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        final EMGroup contactListInfo = list.get(position);
...
//        }
        holder.text_name.setText(contactListInfo.getGroupName());
        return convertView;
    }
