 ...
 *
 */
public class PublicDynamicManager implements Runnable,UploadImageService.UploadImageCallback{
    ...
    public PublicDynamicManager(List<UploadImage> images, Context context) {
        this.images = images;
