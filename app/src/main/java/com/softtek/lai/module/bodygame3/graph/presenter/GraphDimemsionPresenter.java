...
public class GraphDimemsionPresenter extends BasePresenter<GraphDimemsionPresenter.GraphGirthView>{

    GraphService service;

    public GraphDimemsionPresenter(GraphGirthView baseView) {
        super(baseView);
        service= ZillaApi.NormalRestAdapter.create(GraphService.class);
    }

    public void getGraph(long accountId,String classsId){
            service.getClassMemberGirthChart(
    ...
    public interface GraphGirthView extends BaseView{

        void onSuccess(List<GirthModel> data);
