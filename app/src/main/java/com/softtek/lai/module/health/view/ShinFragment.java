...
public class ShinFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener,HealthRecordManager.HealthRecordCallBack{
...
//    @Subscribe
//    public void getWeightList(HealthdoLegGirthModel healthdoLegGirthModel) {
