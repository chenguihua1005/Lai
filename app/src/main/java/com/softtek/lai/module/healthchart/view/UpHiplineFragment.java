...
import com.softtek.lai.module.healthchart.model.UpArmGirthlistModel;
...
public class UpHiplineFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener,
        HealthRecordManager.HealthRecordCallBack<HealthUpArmGirthModel>,View.OnClickListener{
    ...
    HealthRecordManager<HealthUpArmGirthModel> healthRecordManager;
    ...
    @Override
    public void getHealthyData(HealthUpArmGirthModel data) {
        try {
            ...
            List<UpArmGirthlistModel> models=data.getUpArmGirthlist();
            float max=0;
