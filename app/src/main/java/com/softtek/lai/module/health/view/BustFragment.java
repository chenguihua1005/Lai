...
public class BustFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener,HealthRecordManager.HealthRecordCallBack{
...
//    @Subscribe
//    public void getFatList(HealthCircrumModel healthCircrumModel) {
//        System.out.println("健康记录体重" + healthCircrumModel.getFirstrecordtime());
//        int n=healthCircrumModel.getCircumlist().size();
//        for (int i=healthCircrumModel.getCircumlist().size()-1;i>-1;i--) {
