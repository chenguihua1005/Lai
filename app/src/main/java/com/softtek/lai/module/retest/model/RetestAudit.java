...
public class RetestAudit {
    ...
    public RetestAudit(String accountId, String weight, String pysical, String fat, String circum, String waistline, String hiplie, String upArmGirth, String upLegGirth, String doLegGirth, String image, String classId) {
        this.accountId = accountId;
        this.weight = weight;
        this.pysical = pysical;
        this.fat = fat;
