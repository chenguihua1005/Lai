...
public class HonorPCFCAdapter extends BaseAdapter {
    private List<StudentHonorInfo> list;
    private LayoutInflater mInflater;
    private Context context;

    public HonorPCFCAdapter(Context context, List<StudentHonorInfo> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        StudentHonorInfo historyHonorInfo=list.get(position);
        if (convertView == null) {
