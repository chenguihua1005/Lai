...
public class ProductInfoFragment extends BaseFragment implements SuperSwipeRefreshLayout.OnPushLoadMoreListener{
    ...
    protected void initDatas() {
        ...
        homeInfoPresenter.getContentByPage(0,1, 2);
    }
    ...
    public void onRefreshView(ProductEvent product){
        if(product.flag==0){
            infos.clear();
            infos.addAll(product.products);
        }else {
            infos.addAll(product.products);
        }
