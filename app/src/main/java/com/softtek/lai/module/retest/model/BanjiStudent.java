...
public class BanjiStudent {
    ...
    public BanjiStudent(String classId, String className, String managerId, String accountId, String mobile, String userName, String photo, String typeDate, String startDate, String AMStatus, String weekth, String currStart, String currEnd) {
        ClassId = classId;
        ClassName = className;
        ManagerId = managerId;
        AccountId = accountId;
