...
public class ClassInfo implements Serializable {
    ...
    public ClassInfo(String classId, String cityId, String className, String classStatus, String createDate, String endDate, String startDate, String managerId, String memberCount) {
        ClassId = classId;
        CityId = cityId;
        ClassName = className;
