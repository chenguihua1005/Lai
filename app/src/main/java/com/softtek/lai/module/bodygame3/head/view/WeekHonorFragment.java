...
public class WeekHonorFragment extends LazyBaseFragment<HonorPresenter> implements HonorPresenter.HonorView {
    ...
    private void selectWeight() {
        ...
        tv_weight_per.setTextColor(ContextCompat.getColor(getContext(),R.color.orange));
        tv_fat_per.setTextColor(ContextCompat.getColor(getContext(),R.color.grey_honor));
    }
    ...
    private void selectFat() {
        ...
        tv_weight_per.setTextColor(ContextCompat.getColor(getContext(),R.color.grey_honor));
        tv_fat_per.setTextColor(ContextCompat.getColor(getContext(),R.color.orange));
    }
