...
public class FatFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener,HealthRecordManager.HealthRecordCallBack{
...
//    @Subscribe
//    public void getFatList(HealthFatModel healthFatModel) {
//        System.out.println("健康记录体重" + healthFatModel.getFirstrecordtime());
