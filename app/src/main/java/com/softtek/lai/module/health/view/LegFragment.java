...
public class LegFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener,HealthRecordManager.HealthRecordCallBack{
...
//        iHealthyRecord.doGetHealthupLegGirthRecords(date,getDateform(nowdate1)+" "+datetime[1],1);
    ...
    @Subscribe
    public void getFatList(HealthupLegGirthModel healthupLegGirthModel) {
        System.out.println("健康记录体重" + healthupLegGirthModel.getFirstrecordtime());
