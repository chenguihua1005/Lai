...
/**
 * Created by jessica.zhang on 4/6/2017.
 */

@InjectLayout(R.layout.fragment_retest)
public class InitAuditFragment extends LazyBaseFragment<InitAuditPresenter> implements View.OnClickListener, AdapterView.OnItemClickListener, PullToRefreshBase.OnRefreshListener2<ListView>, InitAuditPresenter.InitAuditList {
...
//        doGetData(UserInfoModel.getInstance().getUserId(),classid ,pageIndex, 10);
        getPresenter().doGetData(UserInfoModel.getInstance().getUserId(), classid, pageIndex, 10);
