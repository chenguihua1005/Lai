...
public class MyPullToListView extends PullToRefreshAdapterViewBase<YLListView> {
    ...
    public MyPullToListView(Context context) {
        super(context);
    }

    public MyPullToListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyPullToListView(Context context, Mode mode) {
        super(context, mode);
    }

    public MyPullToListView(Context context, Mode mode, AnimationStyle style) {
    ...
    protected YLListView createListView(Context context, AttributeSet attrs) {
        final YLListView lv;
    ...
    final class InternalListViewSDK9 extends InternalListView {
        ...
        protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
            ...
            OverscrollHelper.overScrollBy(MyPullToListView.this, deltaX, scrollX, deltaY, scrollY, isTouchEvent);

            return returnValue;
        }
    }

    protected class InternalListView extends YLListView implements EmptyViewMethodAccessor {
