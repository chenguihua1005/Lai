 ...
 */
public class DotSpanMy implements LineBackgroundSpan {
     ...
     * @param color  color of the dot
     */
    public DotSpanMy(float radius, int color) {
        this.radius = radius;
        this.color = color;
    }
