...
public class DragFloatActionButtonCheng extends Button{
    ...
    public DragFloatActionButtonCheng(Context context) {
        super(context);
        init();
    }

    public DragFloatActionButtonCheng(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DragFloatActionButtonCheng(Context context, AttributeSet attrs, int defStyleAttr) {
