...
import static com.softtek.lai.widgets.materialcalendarview.MaterialCalendarView.SHOW_DEFAULTS;
...
abstract class CalendarPagerView extends ViewGroup implements View.OnClickListener {
    ...
    public CalendarPagerView(@NonNull MaterialCalendarView view,
        ...
        this.mcv = view;
        this.firstViewDay = firstViewDay;//本月的第一天， 如：3-1
        this.firstDayOfWeek = firstDayOfWeek;

        setClipChildren(false);
        setClipToPadding(false);

        //建立星期的顺序,是周日到周六,还是周几到周几,每一种排列,日期的显示就需要做相应的变化
