...
import com.softtek.lai.widgets.materialcalendarview.format.ArrayWeekDayFormatter;
import com.softtek.lai.widgets.materialcalendarview.format.DateFormatTitleFormatter;
import com.softtek.lai.widgets.materialcalendarview.format.DayFormatter;
import com.softtek.lai.widgets.materialcalendarview.format.MonthArrayTitleFormatter;
import com.softtek.lai.widgets.materialcalendarview.format.TitleFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    private static CalendarDay selectedMonthDay = CalendarDay.today();//当前选中的日期
...
//            } else {
//                currentMonth = selectedMonthDay;
//            }
            currentMonth = adapter.getItem(position);
            Log.e("pageChangeListener... ", "currentMonth =" + currentMonth);
            Log.e("pageChangeListener... ", "selectedMonthDay =" + selectedMonthDay);

//            if (calendarMode == CalendarMode.WEEKS) {
//                if (!isSameDay(currentMonth.getDate(), selectedMonthDay.getDate())) {
//
//
//                }
//            }
...
//                    titleChanger.change(currentMonth);
                    datepageChangeListener.onDatePageSelected(MaterialCalendarView.this, currentMonth);
                }
//                else {
////                    titleChanger.change(selectedMonthDay);
//                    datepageChangeListener.onDatePageSelected(MaterialCalendarView.this, selectedMonthDay);
//                }
    ...
    private OnDatePageChangeListener datepageChangeListener;
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        buttonFuture.setContentDescription(getContext().getString(R.string.next1));
...
//                    Color.BLUE
            ...
            if (leftMask == null) {
                leftMask = getResources().getDrawable(R.drawable.mcv_action_previous);//左按钮
            }
            ...
            if (rightMask == null) {
                rightMask = getResources().getDrawable(R.drawable.mcv_action_next);//右按钮
            }
...
//jessica
            selectedMonthDay = CalendarDay.today();
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            a.recycle();
    ...
    private void setupChildren() {
        ...
        buttonPast.setImageResource(R.drawable.left_btn);
        ...
        buttonFuture.setImageResource(R.drawable.right_btn);
...
//        titleChanger.change(currentMonth);
    ...
    /**
     * Set a {@linkplaincom.rainim.app.widget.materialcalendarview.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @seecom.rainim.app.widget.materialcalendarview.format.ArrayWeekDayFormatter
     * @see#setWeekDayFormatter(com.rainim.app.widget.materialcalendarview.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplaincom.rainim.app.widget.materialcalendarview.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @seecom.rainim.app.widget.materialcalendarview.format.MonthArrayTitleFormatter
     * @see#setTitleFormatter(com.rainim.app.widget.materialcalendarview.format.TitleFormatter)
     */
    ...
    public void setDatepageChangeListener(OnDatePageChangeListener listener) {
        this.datepageChangeListener = listener;
    }
...
//                }
    ...
    protected void onDateClicked(DayView dayView) {
        ...
        Log.e("onDateClicked...", "system ... currentMonth =" + getCurrentDate());
        Log.e("onDateClicked...", "system ... selectedMonth =" + dayView.getDate());

        //add jessica
        selectedMonthDay = dayView.getDate();
...
//            instance.setTime(new Date());
        ...
        CalendarDay defaultDate = new CalendarDay(instance.getTime());
