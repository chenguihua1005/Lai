...
/**
 * Created by shelly.xu on 11/19/2016.
 */
...
public class NiceSpinner2 extends TextView {
    ...
    public NiceSpinner2(Context context) {
        super(context);
        init(context, null);
    }

    public NiceSpinner2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public NiceSpinner2(Context context, AttributeSet attrs, int defStyleAttr) {
