...
public class ArrowSpinner extends TextView {
    ...
    public ArrowSpinner(Context context) {
        super(context);
        init(context, null);
    }

    public ArrowSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ArrowSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        //int topPadding=resources.getDimensionPixelSize(R.dimen.three_grid_unit);
        //setPadding(topPadding, topPadding, topPadding, defaultPadding);
        setClickable(true);
...
//                setText(adapter.getItemInDataset(position).toString());
    ...
    public void showDropDown() {
        ...
        popupWindow.showAsDropDown(this,0,-40);
    }
